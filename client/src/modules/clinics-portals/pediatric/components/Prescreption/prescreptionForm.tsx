  ...
  return (
    <>
      <Grid container spacing={2} columns={8}>
        <Grid item xs={8}>
          <Item>
            <TextField fullWidth label="Drug" id="Drug" onChange={handleInputChange} />
          </Item>
        </Grid>
        <Grid item xs={4}>
          <TextField fullWidth label="Dose" id="Dose" onChange={handleInputChange} />
        </Grid>
        <Grid item xs={4}>
          <TextField fullWidth label="Time" id="Time" onChange={handleInputChange} />
        </Grid>
        <Grid item xs={8}>
          <TextField
            id="Notes"
