...
import { book_appt, get_all_slots, get_appointment_data, get_doctor_slots, get_previous_appointments, get_upcoming_appointments, post_examination } from "../controllers/dataController";
